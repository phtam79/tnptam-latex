...
Hàm subs không thực hiện các chức năng sau đây 
}{
\bonpa{4}
...
% }{
% \bonpa{3}
% {Gọi một tệp *.txt bằng lệnh inline!read!}
% {Nhập các dòng lệnh với [Shift]+[Enter] }
% {Nhập từng dòng lệnh sau dấu \lstinline!>!}
% {Gọi một tệp *.mws bằng lệnh  \lstinline!read!}
% }{ }
...
% Lập một thủ tục sqrt3:=proc(a::numeric, b::numeric, c::numeric, ans::evaln) ans:=sqrt(a*b*c); end; khi đó sqrt3(s,5,5,ans) sẽ cho kết quả
% }{
% \bonpa{2}
% {5}
% {Thông báo lỗi do s}
...
Trong chế độ mặc định thì hai lệnh >evalf(Pi,11); và >evalf(Pi); là
}{
\bonpa{4}
{Không tính được giá trị thứ nhất}
...
% Ta thực hiện lệnh $>$pi:=evalf(Pi); và $>$er:=evalf(pi-Pi,15); cho kết quả er bằng 
% }{
% \bonpa{2}
% {0}
% {số âm}
...
% Thực hiện lệnh \lstinline!z6:-add(5,4);! thì hàm add(5,4) lấy 
% }{
% \bonpa{2}
% {trong module z6}
% {định nghĩa trước đó}
...
Khối cấu trúc lập trình nào sau đây không có trong Maple 
}{
\bonpa{1}
{case}
{for-do}
